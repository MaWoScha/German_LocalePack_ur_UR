# Urdu Sprachpaket für Magento (CE)
(Magento Community Modules - Urdu (General) Language Pack)<br />
(Módulos de Magento Community - Paquete de idioma urdu)
...
* Eigene Sprachversion basierend auf ur_UR
...
Viel Spaß mit dem Urdu Magento Sprachpaket!

Enjoy the Urdu Magento Language Pack!
...
This is a derived work of [German LocalePack ur_UR](https://github.com/MaWoScha/German_LocalePack_ur_UR),<br />
...
Dies ist eine abgeleitete Arbeit von [German LocalePack ur_UR](https://github.com/MaWoScha/German_LocalePack_ur_UR),<br />
...
Se trata de una obra derivada de [German LocalePack ur_UR](https://github.com/MaWoScha/German_LocalePack_ur_UR),<br />
...
for using standard urdu as a fallback language.

Sie sollten
* [German LocaleFallback](https://github.com/MaWoScha/German_LocaleFallback)
für die Verwendung von Standard-Urdu als Ausweichsprache zu verwenden.

Usted debe usar
* [German LocaleFallback](https://github.com/MaWoScha/German_LocaleFallback)
para poder utilizar el Urdu Standard como idioma de reserva.
