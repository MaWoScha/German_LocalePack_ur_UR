 ...
 */
class German_LocalePackUr_Block_System_Config_Form_Fieldset_Instructions
    extends Mage_Adminhtml_Block_System_Config_Form_Fieldset
{
    public function render(Varien_Data_Form_Element_Abstract $element)
    {
    	$nodepath = "modules/German_LocalePackUr";
    	$helper = Mage::helper("localepackur");
	...
	if (!array_key_exists("German_LocaleFallback", $modules)) {
        $html .= "<p>".$helper->__("Note: Install the extension %s, so you can use ur_UR as a <a href='%s'>fallback language</a>.",
        		"<a href='https://github.com/MaWoScha/German_LocaleFallback'>German LocaleFallback</a>",
        		$section_link )."</p>";
	}
        $html .= "<p style='margin-top:20pt;'>";
		$html .= $helper->__("On the <a href='%s'>Magento Connect page of the Urdu language pack</a>, you can find more information on the latest versions.",
